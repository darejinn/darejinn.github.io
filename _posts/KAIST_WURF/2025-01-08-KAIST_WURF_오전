---
title:  "[KAIST_WURF]0108 카이스트 박종은 교수님" 
excerpt: ""
...
enzyme > cell biology > tissue biology

## Sanger 연구소와 공동연구

> 내 연구가 언제든 다른 사람에 의해 먼저 발표될 수 있지 않을까?
- Human Cell Atlas에서 Imune cell development
- 여러 명이 하나의 가치를 추구하는 환경(경쟁이 아닌, 공동연구)
> 카이스트 의과학대학원 또한, 비슷한 환경이다!
> - 여러 연구실이 연결되어 있음.
...
- evolution 과정을 통해서 encoding된 genome이 decoding된 결과

> organism을 single-cell spatial multi-omics로 human Digital Twin으로 encoding, perturbation 과정으로 decoding해서, in vitro human body를 만들 것

# Human cell atlas의 현재 : Encoding
## Human digital twin 
